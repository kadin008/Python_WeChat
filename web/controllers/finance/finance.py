...
from common.libs.helper import ops_render, iPagination, selectFilterObj, getDicListFilterField, getDicFilterField, getCurrentDate
...
def index():
    ...
    if pay_list:
        ...
        pay_order_items_map = getDicListFilterField(PayOrderItem, PayOrderItem.pay_order_id, 'pay_order_id', pay_order_ids)
        ...
        if pay_order_items_map:
            ...
            food_mapping = getDicFilterField(Food, Food.id, 'id', food_ids)
...
def payInfo():
    ...
    if order_item_list:
        food_map = getDicFilterField(Food, Food.id, 'id', selectFilterObj(order_item_list,'food_id'))
